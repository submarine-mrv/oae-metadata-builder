...
import { IconAlertCircle, IconBulb, IconInfoCircle, IconUser } from "@tabler/icons-react";
  ...
  return (
    ...
    >
      <Group align="flex-start" gap="xs" wrap="nowrap">
        ...
        <Box>
          {title && (
            <Text fw={600} size="sm" mb={4} style={{ color: styles.titleColor }}>
              {title}
            </Text>
          )}
          <Text component="div" size="sm" style={{ color: styles.textColor, lineHeight: 1.6 }}>
            {children}
          </Text>
        </Box>
      </Group>
