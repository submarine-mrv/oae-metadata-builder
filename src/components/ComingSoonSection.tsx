        ...
        <Flex direction={{ base: "column", md: "row" }} align="center" gap="xl">
          <Box style={{ flex: 1 }}>
            ...
            <Text mb="lg" style={{ color: "var(--brand-abyssal)" }}>
              We are actively working on example templates to make getting started even easier.
              These will be available directly from this page once released.
            </Text>
          </Box>
          ...
          <Box style={{ flex: 1, width: "100%" }}>
            ...
            >
              <Title order={3} mb="md" c="hadal.9" style={{ fontSize: "1.125rem" }}>
                Planned Templates
              </Title>
              <Stack gap="sm">
                {items.map((item) => (
                  ...
                  >
                    <Box style={{ color: "var(--brand-midnight)" }}>{item.icon}</Box>
                    <Text size="sm" fw={500}>
                      {item.text}
                    </Text>
                  </Box>
