...
/**
 * DateTimePickerPopoverV2 - Simplified visual date/time picker
 *
 * All times are treated as UTC throughout - no timezone conversions.
 */

interface DateTimePickerPopoverV2Props {
  opened: boolean;
...
const DateTimePickerPopoverV2: React.FC<DateTimePickerPopoverV2Props> = ({
  opened,
  onChange,
  value,
  onDateTimeChange,
...
export default DateTimePickerPopoverV2;
