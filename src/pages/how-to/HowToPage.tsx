import { Badge, Box, Container, Flex, Group, Paper, SimpleGrid, Text, Title } from "@mantine/core";
import { IconArrowRight, IconShare, IconUser } from "@tabler/icons-react";
    ...
    <AppLayout>
      ...
      <Box component="header" pt={64} pb={48} px="md">
        <Container size="md" style={{ textAlign: "center" }}>
          ...
          <Text size="xl" mx="auto" maw="42rem" c="abyssal.6" style={{ lineHeight: 1.625 }}>
        ...
        <Container size="md" px="md">
          <Box mb={48} style={{ textAlign: "center" }}>
            ...
            <Text mx="auto" maw="42rem" c="abyssal.6">
              The Metadata Builder uses a three-level hierarchy to organize your scientific data.
          ...
          <Box mt="xl" mb={48} style={{ textAlign: "center" }}>
            <Text size="sm" c="midnight.4" style={{ fontStyle: "italic" }}>
              Each level captures different information, forming a single complete record.
            </Text>
          </Box>
          ...
          <Flex direction="column" gap="xl">
            ...
            >
              ...
              <Box mb="md">
                ...
                <Text c="abyssal.6" style={{ lineHeight: 1.625 }}>
                  Describes the overall effort and only needs to be completed once per project.
                  Includes project name, participating organizations, objectives, geographic region,
                  and governance information. Think of this as the context that all experiments and
                  datasets belong to.
                </Text>
              </Box>
              <Box
            ...
            >
              ...
              <Box mb="md">
                ...
                <Text c="abyssal.6" style={{ lineHeight: 1.625 }}>
                  Represents a coherent operational or scientific unit within the project, such as a
                  field deployment, monitoring phase, or seasonal trial.
                </Text>
              </Box>
              <Box
                pt={8}
              ...
              >
                <CalloutBox variant="tip" title="For Suppliers">
                  It may be helpful to think of an experiment as roughly equivalent to a crediting
                  cycle or a defined operational phase.
                </CalloutBox>
                <CalloutBox variant="who" title="Who typically fills this out?">
                  Often the same person who manages the project metadata, especially when
                  consistency across experiments matters.
                </CalloutBox>
              </Box>
            </Paper>
            ...
            >
              ...
              <Box mb="md">
                ...
                <Text c="abyssal.6" style={{ lineHeight: 1.625 }}>
                  Captures detailed information about specific data files, including generation
                  methods, instruments, resolution, formats, and variable-level details. This is
                  usually the most detailed part of the metadata.
                </Text>
              </Box>
              <Box
                pt={8}
      ...
      <Box component="section" py={80} style={{ backgroundColor: "var(--brand-white)" }}>
        <Container size="md" px="md">
          <Box mb={48}>
            <Title
              order={2}
          ...
          <Flex direction="column" gap="xl">
            ...
            >
              <CalloutBox variant="tip" title="Flexible Order">
                ...
                only a dataset, or only an experiment, or any combination — whatever your role
                requires.
              </CalloutBox>
            </StepCard>
            ...
            >
              <CalloutBox variant="tip" title="Collaboration Tip">
                ...
                person can export their sections independently, and a coordinator can import and
                combine them.
              </CalloutBox>
            </StepCard>
          </Flex>
          ...
          <Box mt="xl">
            <CalloutBox variant="important" title="Do Not Edit JSON Files Directly">
              The Metadata Builder includes automated validation tests that run when metadata is
              created or modified. Editing the JSON file directly in a text editor bypasses these
              checks and may introduce errors. Always import your JSON file back into the builder,
              make your changes there, and export a revised version.
            </CalloutBox>
          </Box>
        </Container>
      </Box>
      ...
      <Box component="section" py={64} style={{ backgroundColor: "var(--brand-white)" }}>
        <Container size="sm" px="md">
          <CalloutBox variant="important" title="Important: Submitting to a Repository">
            <Text component="span" style={{ display: "block", marginBottom: "1rem" }}>
              When you submit a dataset to a repository, dataset metadata alone is not sufficient.
            </Text>
            <Text component="span" style={{ display: "block", marginBottom: "1rem" }}>
              Each submission must include the JSON metadata files for the associated dataset,
              experiment, and project. This ensures future users can understand the full context and
              correctly interpret methods.
            </Text>
            <Group gap={8} c="hadal.9" style={{ fontWeight: 500 }}>
              <IconArrowRight size={16} />
              <Text>The Metadata Builder packages all of this together when you export.</Text>
            </Group>
          </CalloutBox>
        </Container>
      </Box>
      ...
      >
        <Container size="sm" px="md">
          ...
          <Text mb="md" c="abyssal.6">
            If you&apos;re unsure how to structure your metadata or want feedback on your approach,
            we encourage you to reach out early. Your input helps shape how the builder evolves.
          </Text>
